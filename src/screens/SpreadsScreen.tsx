...
const RWS_SPREAD_DETAILS: Record<string, SpreadDetailsContent> = {
  ...
  we_and_perspective: {
    ...
    metaLine: "3 карты · текущая динамика · перспектива",
    header: "Мы и перспектива",
    purpose: [
      "💞 Быстро увидеть баланс между вами",
      "🧭 Понять состояние партнёра",
      "🔮 Оценить ближайшую перспективу отношений"
    ],
    howItWorks: ["🃏 3 позиции: вы, партнёр, перспектива", "Даёт короткий и ясный срез отношений"],
    forWhom: ["✓ Для стартовой проверки связи", "✓ Когда нужен ответ без перегруза"]
  },
  relationship_analysis: {
    subtitle: "Крест с центром проблемы",
    metaLine: "5 карт · чувства + узел конфликта · итог",
    header: "Анализ отношений",
    purpose: [
      "🧠 Разобрать отношения по ключевым слоям",
      "🎯 Выделить главный узел в центре",
      "📈 Понять потенциал и реальный итог"
    ],
    howItWorks: ["🃏 5 позиций: чувства сторон, центр проблемы, потенциал, итог", "Центральная карта показывает фокус для работы"],
    forWhom: ["✓ Для напряжённых отношений", "✓ Когда нужно понять, куда двигаться дальше"]
  },
  new_person: {
    subtitle: "Проверка нового знакомства",
    metaLine: "5 карт · линия знакомства · итог внизу",
    header: "Новый человек",
    purpose: [
      "👤 Понять, кто перед вами на самом деле",
      "🧾 Увидеть намерения и риски",
      "✨ Получить внятный вывод по перспективе"
    ],
    howItWorks: ["🃏 4 карты в линии + 1 итог ниже", "Показывает путь от первого впечатления к развязке"],
    forWhom: ["✓ Для новых знакомств", "✓ Для ранней диагностики потенциальной связи"]
  },
  love_triangle: {
    subtitle: "Динамика трёх участников",
    metaLine: "7 карт · роли · чувства · скрытая динамика · итог",
    header: "Любовный треугольник",
    purpose: [
      "🔺 Разложить роли каждого участника",
      "💔 Понять распределение чувств",
      "🧩 Увидеть скрытый сценарий и исход"
    ],
    howItWorks: ["🃏 Треугольная схема + 2 нижние карты динамики и итога", "Верхний блок о людях, нижний о развитии ситуации"],
    forWhom: ["✓ Для сложных любовных сценариев", "✓ Когда важно увидеть весь контекст, а не один ответ"]
  },
  future_relationships: {
    subtitle: "Дуга развития отношений",
    metaLine: "5 карт · состояние → результат",
    header: "Будущее отношений",
    purpose: [
      "📍 Зафиксировать текущую точку пары",
      "⏳ Оценить ближайший этап",
      "🛠️ Понять, что укрепит связь в долгую"
    ],
    howItWorks: ["🃏 5 карт по дуге от настоящего к итогу", "Линия чтения даёт ощущение движения вперёд"],
    forWhom: ["✓ Для планирования отношений", "✓ Когда нужен прогноз без излишней сложности"]
  },
  conflict_reason: {
    subtitle: "Причина и развязка конфликта",
    metaLine: "5 карт · вертикальный анализ · решение",
    header: "Причина конфликта",
    purpose: [
      "🔥 Увидеть корень конфликта",
      "⚖️ Разделить роли обеих сторон",
      "🕊️ Найти реальный путь к разрешению"
    ],
    howItWorks: ["🃏 5 позиций: корень, ваша роль, центр-узел, роль партнёра, решение", "Акцент на центральной карте как на точке блокировки"],
    forWhom: ["✓ Для острых и повторяющихся споров", "✓ Когда нужен конструктивный выход"]
  },
  will_he_return: {
    subtitle: "Путь от чувств к финальному ответу",
    metaLine: "5 карт · пошаговая линия · итог",
    header: "Вернётся ли человек?",
    purpose: [
      "💬 Понять реальные чувства человека",
      "🧭 Увидеть его намерения и шансы",
      "✅ Получить итог по возвращению"
    ],
    howItWorks: ["🃏 5 позиций читаются слева направо", "Каждая карта — следующий шаг в логике ситуации"],
    forWhom: ["✓ Для вопросов после расставания", "✓ Когда важно увидеть путь, а не только «да/нет»"]
  },
  karmic_connection: {
    subtitle: "Круг с центральной сутью связи",
    metaLine: "7 карт · уроки · плюсы/минусы · предназначение",
    header: "Кармическая связь",
    purpose: [
      "♾️ Понять тип и смысл вашей связи",
      "📚 Увидеть кармические уроки сторон",
      "🧷 Определить риски и предназначение союза"
    ],
    howItWorks: ["🃏 Круг позиций вокруг центральной карты-сути", "Центр — о природе связи, периферия — о её задачах"],
    forWhom: ["✓ Для глубоких «судьбоносных» отношений", "✓ Когда нужен духовный, а не только бытовой взгляд"]
  }
};
