...
export const SpreadStar: SpreadSchema = {
  ...
  openOrder: [1, 2, 3, 4, 5, 6, 7],
  positions: [
    { id: 1, label: "Корневая чакра", x: -210, y: 120 },
    { id: 2, label: "Сакральная чакра", x: -140, y: 70 },
    { id: 3, label: "Чакра солнечного сплетения", x: -70, y: 30 },
    { id: 4, label: "Сердечная чакра", x: 0, y: 0 },
    { id: 5, label: "Горловая чакра", x: 70, y: 30 },
    { id: 6, label: "Чакра третьего глаза", x: 140, y: 70 },
    { id: 7, label: "Коронная чакра", x: 210, y: 120 }
  ]
};
