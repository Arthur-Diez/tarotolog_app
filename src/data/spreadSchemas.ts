...
export const SpreadCelticCross: SpreadSchema = {
  ...
  positions: [
    { id: 1, label: "Ситуация", x: -40, y: 0 },
    { id: 2, label: "Препятствие", x: -40, y: 0 },
    { id: 3, label: "Далекое прошлое", x: -40, y: -240 },
    { id: 4, label: "Недавнее прошлое", x: -40, y: 240 },
    { id: 5, label: "Сознательное", x: 180, y: 0 },
    { id: 6, label: "Бессознательное", x: -260, y: 0 },
    { id: 7, label: "Ваша позиция", x: 390, y: 360 },
    { id: 8, label: "Окружение", x: 390, y: 120 },
    { id: 9, label: "Надежды и страхи", x: 390, y: -120 },
    { id: 10, label: "Результат", x: 390, y: -360 }
  ]
};
