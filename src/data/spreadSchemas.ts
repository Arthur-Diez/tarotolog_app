...
export const SpreadCelticCross: SpreadSchema = {
  ...
  positions: [
    ...
    { id: 3, label: "Далекое прошлое", x: 0, y: -240 },
    { id: 4, label: "Недавнее прошлое", x: 0, y: 240 },
    { id: 5, label: "Сознательное", x: 220, y: 0 },
    { id: 6, label: "Бессознательное", x: -220, y: 0 },
    { id: 7, label: "Ваша позиция", x: 500, y: 360 },
    { id: 8, label: "Окружение", x: 500, y: 120 },
    { id: 9, label: "Надежды и страхи", x: 500, y: -120 },
    { id: 10, label: "Результат", x: 500, y: -360 }
  ]
};
