  ...
  switch (trigger) {
    ...
    case "first_purchase":
      return {
        ...
        body: "Сейчас можно войти в энергию на лучших условиях: забрать скидку и сразу получить больше энергии на старт.",
        cta: "Открыть энергию"
      };
    case "zero_balance":
      return {
        ...
        body: "Энергия на нуле. Сейчас можно быстро пополнить запас на выгодных условиях и снова открыть расклады, трактовки и прогнозы.",
    ...
    case "low_energy":
      return {
        ...
        body: "Энергии осталось немного. Сейчас удобно пополнить запас со скидкой и не прерываться в самый интересный момент.",
        cta: "Усилить запас"
      };
    case "comeback":
      return {
        ...
        body: "Хороший момент вернуться в личный ритм. Для вас уже открыт пакет со скидкой и бонусной энергией.",
    ...
    case "exit_intent":
      return {
        ...
        body: "Если хотите войти на лучших условиях, сейчас как раз хороший момент: можно забрать скидку и получить больше энергии.",
        cta: "Забрать бонус"
      };
    case "post_ads":
      return {
        ...
        body: "Вы уже получили бонус. Если хотите открыть больше сценариев без ожидания, сейчас можно взять пакет со скидкой и бонусной энергией.",
    ...
    case "vip":
      return {
        ...
        body: "Сейчас открыт крупный пакет на лучших условиях, чтобы надолго закрыть вопрос с энергией и не думать о пополнении.",
    ...
    case "scheduled":
      return {
        ...
        body: "На ограниченное время открыт пакет со скидкой и бонусной энергией. Хороший момент пополнить запас выгоднее обычного.",
        cta: "Открыть предложение"
      };
    case "manual":
    default:
